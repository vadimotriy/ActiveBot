...
TEST = {
    ...
    (0, 1): "Пользователь умеет работать с людьми, но не хочет.",
    (1, 0): "Пользователь не умеет работать с людьми, но хочет.",
...
Если с данным все порядке то выводи ответ в формате HTML, кторую принимает телеграм. Тоесть это теги <b> <s> <i> <u> (необязательно все использовать). 
Не задавай пользователю вопросы (не уточняй ничего) и не предлагай никаких либо улучшений по типу "Если хочешь, я могу ...". Тебе необходимо проанализоровать его данные, 
