...
Если с данным все порядке то выводи ответ в формате HTML, кторую принимает телеграм. Тоесть МОЖНО ИСПОЛЬЗОВАТЬ ТОЛЬКО ЭТИ ТЕГИ: <b> <s> <i> <u> (необязательно использовать прям все). 
